...
const AstroYogaSection: NextPage<AstroYogaSectionType> = ({
  ...
  const images = [
    "/1-2@2x.png", "/2-2@2x.png", "/3-2@2x.png", "/4-1@2x.png", "/5-1@2x.png",
    "/6-1@2x.png", "/7-1@2x.png", "/8@2x.png", "/image-collection@2x.png", "/10@2x.png",
    "/image-collection1@2x.png", "/image-collection2@2x.png", "/image-collection3@2x.png",
    "/image-collection4@2x.png", "/image-collection5@2x.png", "/image-collection6@2x.png",
    "/image-collection7@2x.png", "/image-collection8@2x.png", "/image-collection9@2x.png",
    "/image-collection10@2x.png", "/image-collection11@2x.png", "/image-collection12@2x.png",
    "/image-collection13@2x.png", "/image-collection14@2x.png", "/image-collection15@2x.png",
  ...
  return (
    ...
    >
      <h1 className="m-0 tracking-wide font-normal">
        Йога-ретриты
      </h1>
        ...
        <div className="self-stretch flex flex-row items-start justify-start gap-6 max-w-full flex-wrap">
          <div className="flex-1 flex flex-col items-start justify-start gap-4 min-w-[300px]">
            ...
            <div className="self-stretch text-dimgray-300">
              <p className="m-0"><span className="font-medium">✓</span> Место cилы (вдали от социума);</p>
              <p className="m-0"><span className="font-medium">✓</span> Йога;</p>
              <p className="m-0"><span className="font-medium">✓</span> Медитации;</p>
              <p className="m-0"><span className="font-medium">✓</span> Нейрографика;</p>
              <p className="m-0"><span className="font-medium">✓</span> Западная астрология;</p>
              <p className="m-0"><span className="font-medium">✓</span> Вегетарианское питание;</p>
              <p className="m-0"><span className="font-medium">✓</span> Удаленное место;</p>
              <p className="m-0"><span className="font-medium">✓</span> Здоровый образ жизни;</p>
              <p className="m-0"><span className="font-medium">✓</span> Практики;</p>
              <p className="m-0"><span className="font-medium">✓</span> Путешествие по острову;</p>
              <p className="m-0"><span className="font-medium">✓</span> Посещение храмов и заповедников;</p>
              <p className="m-0"><span className="font-medium">✓</span> Цигун;</p>
              <p className="m-0"><span className="font-medium">✓</span> Каждый выбирает свою цель и свой тип ретрита (духовный, творческий, биохакинг).</p>
            </div>
